...
num_rows = 2_000_000
chunk_size = 100_000  # write in chunks to avoid memory issues
...
with open(output_file, "w") as f:
    ...
    for i in range(num_rows):
        ...
        # Optionally, make slight variations to title or year to increase uniqueness
